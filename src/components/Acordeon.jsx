...
const items = [
  { title: 'Terapia 1:1', content: 'Sesiones individuales personalizadas para el crecimiento personal.' },
  { title: 'Terapia grupal', content: 'Sesiones en grupo para compartir experiencias y apoyo mutuo.' }
];
